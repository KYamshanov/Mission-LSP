...
public class CustomDecorationWindowProc implements WinUser.WindowProc {
    ...
    //TODO try to change the height of the title bar.
    final int WM_NCCALCSIZE = 0x0083, WM_NCHITTEST = 0x0084, TITLE_BAR_HEIGHT = 27;
    ...
    @Override
    public WinDef.LRESULT callback(HWND hwnd, int uMsg, WPARAM wparam, LPARAM lparam) {
        WinDef.LRESULT lresult;
        switch (uMsg) {
            case WM_NCCALCSIZE:
